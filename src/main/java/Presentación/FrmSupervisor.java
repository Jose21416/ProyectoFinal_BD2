...
public class FrmSupervisor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnInscribir.setText("Inscripciones");
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGap(15, 15, 15)
                .addComponent(btnInscribir, javax.swing.GroupLayout.DEFAULT_SIZE, 47, Short.MAX_VALUE)
                .addGap(53, 53, 53)
        ...
        jMenuItem1.setText("Gestión de notas");
    ...
    private void btnInscribirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInscribirActionPerformed
        FrmInscripcion fi = new FrmInscripcion();
        jDesktopPane1.add(fi);
        fi.show();
    }//GEN-LAST:event_btnInscribirActionPerformed

    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
        FrmGestionNotas fgn = new FrmGestionNotas();
        fgn.show();
