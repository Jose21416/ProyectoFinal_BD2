...
public class FrmCursos extends javax.swing.JFrame {
   ...
   public FrmCursos() {
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/cursos.png"))); // NOI18N

        jButton1.setFont(new java.awt.Font("Segoe UI Black", 0, 14)); // NOI18N
        jButton1.setText("Importar Tabla");
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGap(30, 30, 30))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(EliminarCursos, javax.swing.GroupLayout.PREFERRED_SIZE, 125, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addGap(35, 35, 35)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(InsertarCursos, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        jLabel1.setText("MODULO DE CREACION DE CURSOS");
    ...
    fileChooser.setDialogTitle("Seleccionar Archivo Excel de Cursos");
    ...
    if (userSelection == JFileChooser.APPROVE_OPTION) {
        ...
        String rutaArchivoExcel = fileToImport.getAbsolutePath();
        
        importarDatosDesdeExcel(rutaArchivoExcel);
    } 
    ...
    private void importarDatosDesdeExcel(String rutaArchivoExcel) {
        try {
            ExcelUtilCursos excelUtil = new ExcelUtilCursos();
            
            List<DCursos> listaCursosAImportar = excelUtil.leerCursosDesdeExcel(rutaArchivoExcel);

        if (listaCursosAImportar.isEmpty()) {
            JOptionPane.showMessageDialog(this, "No se encontraron datos válidos para importar.", "Advertencia", JOptionPane.WARNING_MESSAGE);
            return;
        }
        
        boolean importacionExitosa = logica.importarCursos(listaCursosAImportar);

        if (importacionExitosa) {
            JOptionPane.showMessageDialog(this, 
                "Importación exitosa. Se insertaron " + listaCursosAImportar.size() + " cursos.", 
            ...
            JOptionPane.showMessageDialog(this, 
                "La importación falló completamente. Revise el log de errores de Java.", 
                "Error de Importación", JOptionPane.ERROR_MESSAGE);
        }
    }catch (Exception e) {
        JOptionPane.showMessageDialog(this, "Error al procesar el archivo: " + e.getMessage(), "Error General de Archivo", JOptionPane.ERROR_MESSAGE);
    }
    }
